...
<form class="ui form" name="headeredit" action="{{route('tracker.update', $part->id)}}" method="POST">
  ...
  <div class="fields">
    ...
    <div class="ten wide field">
        <x-form.select label="Type" name="part_type_id" :options="\App\Models\PartType::where('folder', 'parts/')->pluck('type', 'id')" placeholder="Type" selected="{{old('part_type_id') ?? $part->part_type_id}}" />
    </div>        
    @else
