        ...
        <div class="grid grid-cols-2 p-2 gap-2">
            <div class="flex flex-col">
                <div class="text-lg font-bold">
                    <a class="underline decoration-dotted hover:decoration-solid hover:text-gray-500" href="https://www.ldraw.org/pt-policies.html">Parts Tracker Policies</a>
                </div>
                <p>
                ...
                @can('create',\App\Models\Part::class)
                    <div class="text-lg font-bold">
                        <a class="underline decoration-dotted hover:decoration-solid hover:text-gray-500" href="{{route('tracker.submit')}}">Submit New Parts</a>
                    </div>
                    <p>
                ...
                @else
                    ...
                    <p>
                        ...
                        and affirmed the <a class="underline decoration-dotted hover:decoration-solid hover:text-gray-500" href="https://www.ldraw.org/article/349.html">Contributor Agreement</a>.<br/> 
                        To become authorized as an author you must first register with the 
                        <a class="underline decoration-dotted hover:decoration-solid hover:text-gray-500" href="https://forums.ldraw.org/member.php?action=register"> LDraw.org Forum</a> (it's free) and then 
