...
__webpack_require__(/*! ../semantic/dist/components/visibility.js */ "./resources/semantic/dist/components/visibility.js");
__webpack_require__(/*! ../semantic/dist/components/modal.js */ "./resources/semantic/dist/components/modal.js");
__webpack_require__(/*! ../semantic/dist/components/search.js */ "./resources/semantic/dist/components/search.js");
__webpack_require__(/*! ../semantic/dist/components/checkbox.js */ "./resources/semantic/dist/components/checkbox.js");
__webpack_require__(/*! ../semantic/dist/components/dropdown.js */ "./resources/semantic/dist/components/dropdown.js");
__webpack_require__(/*! ../semantic/dist/components/sidebar.js */ "./resources/semantic/dist/components/sidebar.js");
__webpack_require__(/*! ../semantic/dist/components/accordion.js */ "./resources/semantic/dist/components/accordion.js");
__webpack_require__(/*! ./tablesort.js */ "./resources/js/tablesort.js");
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ui.login.modal').modal();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ui.sidebar').sidebar('attach events', '#menubutton', 'show');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ui.checkbox').checkbox();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ui.dropdown').dropdown();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search.dropdown').dropdown();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ui.accordion').accordion();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('table.sortable').tablesort();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ui.menu > .ui.dropdown').dropdown({
    on: 'hover'
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ui.sitesearch').each(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).search({
      apiSettings: {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ui.ptsearch').each(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).search({
      apiSettings: {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.feed.image').visibility({
    type: 'image'
  });
});
...
/***/ "./resources/semantic/dist/components/accordion.js":
/*!*********************************************************!*\
  !*** ./resources/semantic/dist/components/accordion.js ***!
  \*********************************************************/
/***/ (() => {
...
/***/ "./resources/semantic/dist/components/checkbox.js":
/*!********************************************************!*\
  !*** ./resources/semantic/dist/components/checkbox.js ***!
  \********************************************************/
/***/ (() => {
...
/***/ "./resources/semantic/dist/components/dropdown.js":
/*!********************************************************!*\
  !*** ./resources/semantic/dist/components/dropdown.js ***!
  \********************************************************/
/***/ (() => {
...
(function ($, window, document, undefined) {
  ...
  $.fn.dropdown = function (parameters) {
    ...
    $allModules.each(function (elementIndex) {
      ...
      module = {
        ...
        create: {
          id: function id() {
            _id = (Math.random().toString(16) + '000000000').slice(2, 10);
        ...
        queryRemote: function queryRemote(query, callback, callbackParameters) {
          ...
          var apiSettings = {
            ...
            apiCallbacks = {
              onError: function onError(errorMessage, $module, xhr) {
              ...
              onFailure: function onFailure(response, $module, xhr) {
                module.add.message(message.serverError);
                iconClicked = false;
                focused = false;
                callback.apply(null, callbackParameters);
              ...
              onSuccess: function onSuccess(response, $module, xhr) {
        ...
        set: {
          ...
          text: function text(_text, isNotPlaceholder) {
            if (settings.action === 'combo') {
              ...
              if (_text !== module.get.placeholderText() || isNotPlaceholder) {
          ...
          exactly: function exactly(value, $selectedItem, preventChangeTrigger) {
        ...
        add: {
          ...
          value: function value(addedValue, addedText, $selectedItem, preventChangeTrigger) {
        ...
        is: {
          ...
          searchSelection: function searchSelection(deep) {
  ...
  $.fn.dropdown.settings = {
    ...
    onActionable: function onActionable(value, text, $selected) {},
...
/***/ "./resources/semantic/dist/components/modal.js":
/*!*****************************************************!*\
  !*** ./resources/semantic/dist/components/modal.js ***!
  \*****************************************************/
/***/ (() => {
...
(function ($, window, document, undefined) {
  ...
  $.modal = $.fn.modal = function (parameters) {
    var $allModules = $(this),
      ...
      returnedValue;
    $allModules.each(function () {
      var _settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.modal.settings, parameters) : $.extend({}, $.fn.modal.settings),
        ...
        moduleNamespace = 'module-' + namespace,
        $module = $(this),
        $context = [window, document].indexOf(_settings.context) < 0 ? $document.find(_settings.context) : $body,
      ...
      module = {
        initialize: function initialize() {
          ...
          if (!isModalComponent) {
            module.create.modal();
            if (!$.isFunction(_settings.onHidden)) {
              _settings.onHidden = function () {
                module.destroy();
                $module.remove();
              };
            }
          }
          $module.addClass(_settings["class"]);
          if (_settings.title !== '') {
            $module.find(selector.title).html(module.helpers.escape(_settings.title, _settings.preserveHTML)).addClass(_settings.classTitle);
          }
          if (_settings.content !== '') {
            $module.find(selector.content).html(module.helpers.escape(_settings.content, _settings.preserveHTML)).addClass(_settings.classContent);
          }
          if (module.has.configActions()) {
            var $actions = $module.find(selector.actions).addClass(_settings.classActions);
            if ($actions.length === 0) {
              $actions = $('<div/>', {
                "class": className.actions + ' ' + (_settings.classActions || '')
              }).appendTo($module);
            } else {
              $actions.empty();
            }
            _settings.actions.forEach(function (el) {
              var icon = el[fields.icon] ? '<i ' + (el[fields.text] ? 'aria-hidden="true"' : '') + ' class="' + module.helpers.deQuote(el[fields.icon]) + ' icon"></i>' : '',
                text = module.helpers.escape(el[fields.text] || '', _settings.preserveHTML),
                cls = module.helpers.deQuote(el[fields["class"]] || ''),
                _click = el[fields.click] && $.isFunction(el[fields.click]) ? el[fields.click] : function () {};
              $actions.append($('<button/>', {
                ...
                click: function click() {
                  var button = $(this);
                  if (button.is(selector.approve) || button.is(selector.deny) || _click.call(element, $module) === false) {
                    return;
                  }
                  module.hide();
                }
        ...
        create: {
          modal: function modal() {
            ...
            if (_settings.closeIcon) {
              $closeIcon = $('<i/>', {
                "class": className.close,
                role: 'button',
                tabindex: 0,
                'aria-label': _settings.text.close
              });
          ...
          dimmer: function dimmer() {
            var defaultSettings = {
              ...
              dimmerSettings = $.extend(true, defaultSettings, _settings.dimmerSettings);
        ...
        refreshInputs: function refreshInputs() {
          if ($inputs) {
        ...
        event: {
          approve: function approve() {
            if (ignoreRepeatedEvents || _settings.onApprove.call(element, $(this)) === false) {
          ...
          deny: function deny() {
            if (ignoreRepeatedEvents || _settings.onDeny.call(element, $(this)) === false) {
          ...
          closeKeyUp: function closeKeyUp(event) {
            var keyCode = event.which;
            if ((keyCode === _settings.keys.enter || keyCode === _settings.keys.space) && $module.hasClass(className.front)) {
              module.hide();
            }
          },
          inputKeyDown: {
            first: function first(event) {
              var keyCode = event.which;
              if (keyCode === _settings.keys.tab && event.shiftKey) {
                $inputs.last().focus();
                event.preventDefault();
              }
            },
          ...
          mousedown: function mousedown(event) {
            ...
            initialMouseDownInScrollbar = module.is.scrolling() && (!isRtl && $window.outerWidth() - _settings.scrollbarWidth <= event.clientX || isRtl && _settings.scrollbarWidth >= event.clientX);
            if (initialMouseDownInScrollbar) {
              module.verbose('Mouse down event registered inside the scrollbar');
            }
          },
          mouseup: function mouseup(event) {
            if (!_settings.closable) {
          ...
          keyboard: function keyboard(event) {
            var keyCode = event.which;
            if (keyCode === _settings.keys.escape) {
              if (_settings.closable) {
        ...
        showModal: function showModal(callback) {
          ...
          if (module.is.animating() || !module.is.active()) {
            if (_settings.onShow.call(element) === false) {
            ...
            if (!_settings.allowMultiple && module.others.active()) {
              ...
              if (_settings.transition && $.fn.transition !== undefined && $module.transition('is supported')) {
                ...
                $module.transition({
                  ...
                  animation: (_settings.transition.showMethod || _settings.transition) + ' in',
                  queue: _settings.queue,
                  duration: _settings.transition.showDuration || _settings.duration,
                  useFailSafe: true,
                  onComplete: function onComplete() {
                    _settings.onVisible.apply(element);
        ...
        hideModal: function hideModal(callback, keepDimmed, hideOthersToo) {
          var $previousModal = $otherModals.filter('.' + className.active).last();
          callback = $.isFunction(callback) ? callback : function () {};
          if (_settings.onHide.call(element, $(this)) === false) {
          ...
          if (module.is.animating() || module.is.active()) {
            ...
            if (_settings.transition && $.fn.transition !== undefined && $module.transition('is supported')) {
              ...
              $module.transition({
                ...
                verbose: _settings.verbose,
                silent: _settings.silent,
                animation: (_settings.transition.hideMethod || _settings.transition) + ' out',
                queue: _settings.queue,
                duration: _settings.transition.hideDuration || _settings.duration,
                useFailSafe: true,
                onStart: function onStart() {
                  if (!module.others.active() && !module.others.animating() && !keepDimmed) {
                    module.hideDimmer();
                  }
                  if (_settings.keyboardShortcuts && !module.others.active()) {
                ...
                onComplete: function onComplete() {
                  ...
                  if ($.isFunction(_settings.onHidden)) {
                    _settings.onHidden.call(element);
                  }
        ...
        restore: {
          focus: function focus() {
            if ($focusedElement && $focusedElement.length > 0 && _settings.restoreFocus) {
        ...
        cacheSizes: function cacheSizes() {
          ...
          if (module.cache.pageHeight === undefined || modalHeight !== 0) {
            $.extend(module.cache, {
              ...
              width: modalWidth,
              height: modalHeight + _settings.offset,
              scrollHeight: scrollHeight + _settings.offset,
        ...
        helpers: {
          deQuote: function deQuote(string) {
        ...
        can: {
          ...
          useFlex: function useFlex() {
            if (_settings.useFlex === 'auto') {
              return _settings.detachable && !module.is.ie();
            }
            if (_settings.useFlex && module.is.ie()) {
              module.debug('useFlex true is not supported in IE');
            } else if (_settings.useFlex && !_settings.detachable) {
              module.debug('useFlex true in combination with detachable false is not supported');
            }
            return _settings.useFlex;
          },
          fit: function fit() {
            var contextHeight = module.cache.contextHeight,
              ...
              paddingHeight = _settings.padding,
        ...
        has: {
          configActions: function configActions() {
            return Array.isArray(_settings.actions) && _settings.actions.length > 0;
          },
        ...
        set: {
          ...
          bodyMargin: function bodyMargin() {
            var position = module.can.leftBodyScrollbar() ? 'left' : 'right';
            if (_settings.detachable || module.can.fit()) {
          ...
          dimmerSettings: function dimmerSettings() {
            ...
            var defaultSettings = {
                ...
                duration: {
                  show: _settings.transition.showDuration || _settings.duration,
                  hide: _settings.transition.hideDuration || _settings.duration
                }
              },
              dimmerSettings = $.extend(true, defaultSettings, _settings.dimmerSettings);
          ...
          modalOffset: function modalOffset() {
            if (!_settings.detachable) {
              ...
              $module.css({
                top: !$module.hasClass('aligned') && canFit ? $document.scrollTop() + (module.cache.contextHeight - module.cache.height) / 2 : !canFit || $module.hasClass('top') ? $document.scrollTop() + _settings.padding : $document.scrollTop() + (module.cache.contextHeight - module.cache.height - _settings.padding),
                marginLeft: -(module.cache.width / 2)
              });
            } else {
              $module.css({
                marginTop: !$module.hasClass('aligned') && module.can.fit() ? -(module.cache.height / 2) : _settings.padding / 2,
                marginLeft: -(module.cache.width / 2)
              });
            }
          ...
          screenHeight: function screenHeight() {
            if (module.can.fit()) {
              ...
              $context.css('height', module.cache.height + _settings.padding * 2);
            }
          },
          active: function active() {
      ...
      if (methodInvoked) {
        if (instance === undefined) {
          if ($.isFunction(_settings.templates[query])) {
            _settings.autoShow = true;
            _settings.className.modal = _settings.className.template;
            _settings = $.extend(true, {}, _settings, _settings.templates[query].apply(module, queryArguments));
...
/***/ "./resources/semantic/dist/components/search.js":
/*!******************************************************!*\
  !*** ./resources/semantic/dist/components/search.js ***!
  \******************************************************/
/***/ (() => {
...
(function ($, window, document, undefined) {
      ...
      module = {
            ...
            var apiSettings = {
              ...
              apiCallbacks = {
                onSuccess: function onSuccess(response, $module, xhr) {
                  ...
                  callback();
                  if (_settings.apiSettings && typeof _settings.apiSettings.onSuccess === 'function') {
                    _settings.apiSettings.onSuccess.call(this, response, $module, xhr);
                  }
                },
                onFailure: function onFailure(response, $module, xhr) {
                  module.displayMessage(error.serverError);
                  callback();
                  if (_settings.apiSettings && typeof _settings.apiSettings.onFailure === 'function') {
                    _settings.apiSettings.onFailure.call(this, response, $module, xhr);
                  }
                },
                onAbort: function onAbort(status, $module, xhr) {
                  if (_settings.apiSettings && typeof _settings.apiSettings.onAbort === 'function') {
                    _settings.apiSettings.onAbort.call(this, status, $module, xhr);
                  }
                },
                onError: function onError(errorMessage, $module, xhr) {
                  module.error();
                  if (_settings.apiSettings && typeof _settings.apiSettings.onError === 'function') {
                    _settings.apiSettings.onError.call(this, errorMessage, $module, xhr);
                  }
                }
              };
            $.extend(true, apiSettings, _settings.apiSettings, apiCallbacks);
        ...
        get: {
          settings: function settings() {
            ...
            if (_settings.ignoreDiacritics && !String.prototype.normalize) {
              _settings.ignoreDiacritics = false;
              module.error(error.noNormalize, element);
            }
          },
          inputEvent: function inputEvent() {
        ...
        set: {
          ...
          type: function type(_type) {
            ...
            if (className[_type]) {
              $module.addClass(className[_type]);
            }
          },
        ...
        remove: {
          ...
          diacritics: function diacritics(text) {
            return _settings.ignoreDiacritics ? text.normalize('NFD').replace(/[\u0300-\u036f]/g, '') : text;
          }
        },
        query: function query(callback) {
          ...
          if (module.has.minimumCharacters()) {
            if (cache) {
              ...
              if ($.isPlainObject(_settings.source) || Array.isArray(_settings.source)) {
        ...
        search: {
          local: function local(searchTerm) {
            var results = module.search.object(searchTerm, _settings.source),
              searchHTML;
            module.set.loading();
            ...
            $.each(searchFields, function (index, field) {
              $.each(source, function (label, content) {
                ...
                if (fieldExists) {
                  ...
                  } else if (_settings.fullTextSearch === 'exact' && module.exactSearch(searchTerm, text)) {
                    // content fuzzy matches (last in results)
                    addResult(exactResults, content);
                  } else if (_settings.fullTextSearch === true && module.fuzzySearch(searchTerm, text)) {
                    // content fuzzy matches (last in results)
        ...
        generateResults: function generateResults(response) {
          ...
          if (isProperObject || isProperArray) {
            ...
            if ($.isFunction(template)) {
              html = template(response, fields, _settings.preserveHTML);
            } else {
        ...
        displayMessage: function displayMessage(text, type, header) {
          type = type || 'standard';
          module.debug('Displaying message', text, type, header);
          module.addResults(_settings.templates.message(text, type, header));
          return _settings.templates.message(text, type, header);
        },
        setting: function setting(name, value) {
          if ($.isPlainObject(name)) {
            $.extend(true, _settings, name);
  ...
  $.fn.search.settings = {
    ...
    templates: {
      ...
      message: function message(_message, type, header) {
        var html = '';
      ...
      category: function category(response, fields, preserveHTML) {
        var html = '',
      ...
      standard: function standard(response, fields, preserveHTML) {
        var html = '',
          escape = $.fn.search.settings.templates.escape;
...
/***/ "./resources/semantic/dist/components/sidebar.js":
/*!*******************************************************!*\
  !*** ./resources/semantic/dist/components/sidebar.js ***!
  \*******************************************************/
/***/ (() => {
...
/***/ "./resources/semantic/dist/components/visibility.js":
/*!**********************************************************!*\
  !*** ./resources/semantic/dist/components/visibility.js ***!
  \**********************************************************/
/***/ (() => {
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/edit"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/edit"], () => (__webpack_require__("./resources/css/app.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","css/edit"], () => (__webpack_require__("./resources/css/edit.css")))
