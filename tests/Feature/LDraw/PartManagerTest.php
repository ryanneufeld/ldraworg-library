...
test('add or change part', function () {
    ...
    $part = $manager->submit([['contents' => file_get_contents(__DIR__ . '/testfiles/parts/3001.dat'), 'filename' => '3001.dat', 'type' => 'text']], $u);
    ...
    $spart = $manager->submit([['contents' => file_get_contents(__DIR__ . '/testfiles/parts/3001s01.dat'), 'filename' => '3001s01.dat', 'type' => 'text']], $u);
